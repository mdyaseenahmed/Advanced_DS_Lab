...
int main()
{
    ...
    cout << "Enter the Total Number Of Elements To Be Inserted in the Binomial Heap: ";
    cin >> n;
    ...
    cout << "The Contents of Binomial Heap is:\n";
    display(root);

    cout << "\nEnter The Elements To Be Deleted: ";
    cin >> item;
    root = binomialHeapDelete(root, item);

    cout << "\nAfter Deleting " << item << ", The Contents Of heap is:\n";
